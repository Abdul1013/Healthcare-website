    ...
    <nav ref={navRef} className="w-full bg-health-orange text-white shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-8 py-1">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a
            href="#"
            className="text-white hover:text-health-pink transition-colors"
            aria-label="Facebook"
          >
          ...
          <a
            href="https://x.com/simplifycareinc?s=21&t=LVKLwjudxP6KETzBDyuecQ"
            target="blank"
            className="text-white hover:text-health-pink transition-colors"
            aria-label="Twitter"
          >
          ...
          <a
            href="https://www.instagram.com/simplifycareinc?igsh=MWZuMnczczUxYnpmYg%3D%3D&utm_source=qr"
            target="blank"
            className="text-white hover:text-health-pink transition-colors"
        ...
        <div className="md:hidden bg-health-orange border-t border-orange-400">
          <div className="px-8 py-4 space-y-4">
            <ul className="space-y-4">
              <li
                className="cursor-pointer hover:text-health-pink transition-colors"
                onClick={() => scrollToSection("hero")}
              >
                Home
              </li>
