    ...
    <section id="testimonials" className="bg-gray-50 py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <div className="h-1.5 w-24 bg-health-green mx-auto rounded-full"></div>
        ...
        <div className="mt-16 text-center">
          <button className="text-health-green font-bold hover:text-health-pink underline underline-offset-8 decoration-health-orange transition-all">
