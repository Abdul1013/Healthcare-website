...
import BlogsModal from "./UI/BlogsModal";
...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div
        id="hero"
        className="w-full min-h-[92vh] bg-cover bg-center flex items-center px-10 animate-fade-in relative"
        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
          <div className="max-w-xl animate-slide-up">
            ...
            <p className="text-white mt-4 text-lg">
              Trusted healthcare at your doorstep. Book now for personalized
              care.
            </p>
          </div>
